...
Pe partea nefuncțională, comparația trebuie să fie corectă, ceea ce înseamnă că singura variabilă între cele două sisteme este arhitectura de recuperare. Rezultatele trebuie să fie reproducibile, de unde și rularea locală și fixarea seed-urilor în evaluare. Sistemul trebuie să ruleze pe o singură placă grafică de consum, fără infrastructură distribuită. În fine, codul trebuie organizat modular, cu pipeline-urile separate de interfață și de modulul de evaluare, pentru ca fiecare componentă să poată fi modificată independent.
...
Configurarea cross-encoderului a cerut câteva încercări. Au fost testate mai multe modele de reranking, inclusiv o variantă mai mare la care s-a renunțat în favoarea lui \texttt{ms-marco-MiniLM-L-6-v2}, care oferă un compromis bun între precizie și viteză. Pool-ul de candidați trimiși la reranking a crescut de la 20 la 40 pe parcurs, după ce s-a observat că un pool mai mic tăia uneori fragmentele relevante înainte ca cross-encoderul să le poată evalua.
...
\subsection{Limitările demonstratorului}
